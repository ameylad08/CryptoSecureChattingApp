...
android {
    namespace = "com.example.securio"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.example.securio"
        minSdk = 24
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    implementation("com.firebase:firebase-ui-firestorm:6.2.1")
    implementation("com.firebase:firebase-ui-database:8.0.0")
